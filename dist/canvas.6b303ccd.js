...
function init() {
    ...
    for (var i = 0; i < numParticles; i++) {
        var _minRadius = Math.floor(randomIntFromRange(0, 5)) + 1;
        particles.push(new Particle(innerWidth / 2, innerHeight / 2, _minRadius, randomColor(colors)));
    }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '10435' + '/');
...
},{}]},{},["..\\..\\..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js","assets\\js\\canvas.js"], null)
//# sourceMappingURL=/canvas.6b303ccd.map